...
<h1 style="text-align:center">Percentage Less Than 50</h1>
...
$greaterthan50 = "select * from table1 where percentage < 50";
...
if ($result->num_rows > 0) {
    ...
    echo "</table></center>";
    echo "<br/>";
    echo "<center><form action='export_ls50.php' method='post'>";
