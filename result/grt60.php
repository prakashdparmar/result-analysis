...
<h1 style="text-align:center">Percentage Between 69 To 60</h1>
...
$greaterthan50 = "select * from table1 where percentage between 60 and 69";
...
if ($result->num_rows > 0) {
    ...
    echo "</table></center>";
    echo "<br/>";
    echo "<center><form action='export_grt60.php' method='post'>";
