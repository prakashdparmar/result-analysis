...
<h1 style="text-align:center">List Of Fail Students</h1>
...
$greaterthan50 = "select * from table1 where result='fail' ";
...
if ($result->num_rows > 0) {
    ...
    echo "</table></center>";
    echo "<br/>";
    echo "<center><form action='export_fail.php' method='post'>";
