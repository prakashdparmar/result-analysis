...
<h1 style="text-align:center">Percentage Between 70 To 79</h1>
...
$greaterthan50 = "select * from table1 where percentage between 70 and 79";
...
if ($result->num_rows > 0) {
    ...
    echo "</table></center>";
    echo "<br/>";
    echo "<center><form action='export_grt70.php' method='post'>";
