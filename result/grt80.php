...
<h1 style="text-align:center">Percentage Between 80 To 100</h1>
...
$greaterthan50 = "select * from table1 where percentage between 80 and 100";
...
if ($result->num_rows > 0) {
    ...
    echo "</table></center>";
    echo "<br/>";
    echo "<center><form action='export_grt80.php' method='post'>";
